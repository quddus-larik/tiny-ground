  ...
  return (
    <div className="w-full flex flex-col gap-0">
      ...
      <div className="flex flex-col items-center justify-center h-auto px-16 mt-32">
        ...
        <div className="w-full z-10 h-[80svh] border-4 border-b-0 border-foreground/10 bg-content1 rounded-t-2xl overflow-hidden shadow-2xl">
          <img
            src="/snapshot.png"
            alt="Snapshot"
      ...
      <div className="bg-background-tertiary py-0 flex flex-col gap-4 justify-center z-20">
        <div className="grid grid-cols-6">
          ...
          {Popularlangauges.map((itm, idx) => (
            <div className="flex flex-row h-32 ring-[0.5px] ring-muted/50 gap-2 items-center justify-center hover:bg-accent-soft transition-colors">
